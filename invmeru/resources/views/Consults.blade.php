        ...
        @isset($resultado)
            @if($resultado)
                @if($resultado->estado == 1)
                    ...
                    <!-- Modal Detalles -->
                    <div id="detallesModal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center z-50">
                    ...
                    <!-- Modal Depósitos -->
                    <div id="depositosModal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center z-50">
...
function openEntradasModal() {
    ...
    fetch(`{{ url('/repuestos') }}/${repuestoId}/entradas`)
        .then(res => res.text()) 
        .then(html => {
